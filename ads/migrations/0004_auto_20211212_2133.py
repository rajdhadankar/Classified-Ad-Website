# Generated by Django 3.1.2 on 2021-12-12 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorites', models.ManyToManyField(related_name='favorite_things', through='ads.Fav', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='fav',
            name='thing',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ads.thing'),
        ),
        migrations.AddField(
            model_name='fav',
            name='user',
